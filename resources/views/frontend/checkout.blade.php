                    ...
                    <div id="wrap-inner">
                        <div id="list-cart">
                            ...
                            <div class="row" id="total-price">
                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <a class="btn btn-warning">Đặt hàng</a>
                                </div>
                            </div>
                        ...
                        <div id="xac-nhan">
                            ...
                            <form action="{{route('pay')}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="add">Ngày đặt hàng</label>
                                    <input style="width:200px" class="form-control" type="text" value="{{date('Y:m:d H:i:s')}}">
                                </div>
                                <div class="form-group">
                                    <label for="add">Dự kiến nhận hàng</label>
                                    <input style="width:200px" class="form-control" type="date" name="update_at">
                                </div>
